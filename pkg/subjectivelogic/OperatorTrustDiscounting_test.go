...
func TestMultiEdgeTrustDisc(t *testing.T) {
	...
	tests := []struct {
		...
		{"TestMultiEdgeTrustDisc9",
			args{[]Opinion{{1, 0, 0, 0.5}, {0, 1, 0, 0.5}}},
			Opinion{0, 1, 0, 0.5},
			false,
		},
		{"TestMultiEdgeTrustDisc10",
			args{[]Opinion{{1, 0, 0, 0.5}, {0, 0, 1, 0.5}}},
			Opinion{0, 0, 1, 0.5},
			false,
		},
		{"TestMultiEdgeTrustDisc11",
			args{[]Opinion{{0, 1, 0, 0.5}, {0.6, 0.3, 0.1, 0}}},
			Opinion{0, 0, 1, 0},
			false,
		},
		{"TestMultiEdgeTrustDisc12",
			args{[]Opinion{{0, 0, 1, 0.5}, {0.6, 0.3, 0.1, 0}}},
			Opinion{0.3, 0.15, 0.55, 0},
			false,
		},
		{"TestMultiEdgeTrustDisc13",
			args{[]Opinion{{0.6, 0.3, 0.1, 0}, {0.091, 0.604, 0.305, 0.4}}},
			Opinion{0.0546, 0.3624, 0.583, 0.4},
			false,
		},
		{"TestMultiEdgeTrustDisc14",
			args{[]Opinion{{0.091, 0.604, 0.305, 0.4}, {0.6, 0.3, 0.1, 0}}},
			Opinion{0.1278, 0.0639, 0.8083, 0},
			false,
		},
		{"TestMultiEdgeTrustDisc15",
			args{[]Opinion{{0.091, 0.604, 0.305, 0.4}, {0.53, 0.227, 0.243, 1.000}}},
			Opinion{0.11289, 0.048351, 0.838759, 1},
			false,
		},
		{"TestMultiEdgeTrustDisc16",
			args{[]Opinion{{0.53, 0.227, 0.243, 1.000}, {0.091, 0.604, 0.305, 0.4}}},
			Opinion{0.070343, 0.466892, 0.462765, 0.4},
			false,
		},
